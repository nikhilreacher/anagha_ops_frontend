...
export default function Dashboard() {
  ...
  const salaryPreview = useMemo(() => {
    ...
    const previousMonthAdvance = Number(selectedEmployee.salary_month_advance || 0)
  ...
  const paySalary = async () => {
    ...
    if (!data.salary_window_open) {
      alert("Salary payment is allowed only from 1st to 10th for now")
      return
    }
    ...
    <div className="space-y-6">
      <div className="grid gap-4 lg:grid-cols-12">
        ...
        >
          ...
          <h2 className="text-sm font-semibold leading-snug text-slate-800 md:text-[0.95rem]">Total Outstanding</h2>
          <div className="mt-auto pt-5">
            <p className="overflow-hidden text-ellipsis whitespace-nowrap text-base font-semibold leading-tight text-rose-600 md:text-lg xl:text-xl 2xl:text-[1.45rem]">
        ...
        >
          ...
          <h2 className="text-sm font-semibold leading-snug text-slate-800 md:text-[0.95rem]">Prev. Day Stock</h2>
          <div className="mt-auto pt-5">
            <p className="overflow-hidden text-ellipsis whitespace-nowrap text-base font-semibold leading-tight text-slate-800 md:text-lg xl:text-xl 2xl:text-[1.45rem]">
        ...
        >
          ...
          <h2 className="text-sm font-semibold leading-snug text-slate-800 md:text-[0.95rem]">Active Dispatches</h2>
          {data.active_dispatches > 0 ? (
            ...
            <div className="mt-auto space-y-1 pt-4">
              <p className="text-base font-semibold leading-tight text-slate-700 md:text-lg xl:text-xl">
        ...
        <button
          ...
          className="group relative flex min-w-0 flex-col justify-between overflow-hidden rounded-[1.35rem] border border-emerald-100 bg-gradient-to-br from-white via-emerald-50/70 to-teal-100/60 p-5 text-left shadow-[0_18px_45px_-28px_rgba(15,118,110,0.45)] transition hover:-translate-y-0.5 hover:shadow-[0_22px_50px_-28px_rgba(15,118,110,0.55)] focus:outline-none focus:ring-2 focus:ring-emerald-200 md:min-h-[148px] lg:col-span-3"
        >
          <div className="pointer-events-none absolute right-0 top-0 h-24 w-24 rounded-full bg-white/45 blur-2xl" />
          <div className="space-y-2">
            <p className="truncate text-xs font-semibold tracking-[0.02em] text-emerald-800/75">
              {data.prev_moc_month || "Prev. MOC"}
            </p>
            <h2 className="text-sm font-semibold leading-snug text-slate-900 md:text-[0.95rem]">Prev. MOC Sales</h2>
          </div>
          <div className="space-y-3 pt-5">
            <p className="break-words text-[1rem] font-semibold leading-snug text-slate-950 md:text-[1.15rem] xl:text-[1.3rem]">
        ...
        >
          <div className="pointer-events-none absolute right-0 top-0 h-24 w-24 rounded-full bg-white/45 blur-2xl" />
          <div className="space-y-2">
            <p className="truncate text-xs font-semibold tracking-[0.02em] text-cyan-900/75">
              {data.prev_moc_month || "Prev. MOC"}
            </p>
            <h2 className="text-sm font-semibold leading-snug text-slate-900 md:text-[0.95rem]">ICD</h2>
          </div>
          <div className="space-y-3 pt-5">
            <p className="break-words text-[0.92rem] font-semibold leading-snug text-slate-950 md:text-[1rem] xl:text-[1.08rem]">
              Sales {formatCurrency(data.prev_moc_icd_sales)}
            </p>
        ...
        <button
          ...
          className="group relative flex min-w-0 flex-col justify-between overflow-hidden rounded-[1.35rem] border border-sky-100 bg-gradient-to-br from-white via-sky-50/70 to-blue-100/65 p-5 text-left shadow-[0_18px_45px_-28px_rgba(37,99,235,0.45)] transition hover:-translate-y-0.5 hover:shadow-[0_22px_50px_-28px_rgba(37,99,235,0.55)] focus:outline-none focus:ring-2 focus:ring-sky-200 md:min-h-[148px] lg:col-span-3"
        >
          <div className="pointer-events-none absolute right-0 top-0 h-24 w-24 rounded-full bg-white/45 blur-2xl" />
          <div className="space-y-2">
            <p className="truncate text-xs font-semibold tracking-[0.02em] text-sky-900/75">
              {data.prev_moc_month || "Prev. MOC"}
            </p>
            <h2 className="text-sm font-semibold leading-snug text-slate-900 md:text-[0.95rem]">Prev. MOC Profit</h2>
          </div>
          <div className="space-y-3 pt-5">
            <p className="break-words text-[1rem] font-semibold leading-snug text-slate-950 md:text-[1.15rem] xl:text-[1.3rem]">
              ...
              <div className="border-t border-slate-200 px-6 py-5 space-y-4">
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                  <p className="text-sm text-gray-600">
                    Salary month: <span className="font-semibold text-slate-900">{data.salary_target_month || "Current Month"}</span>
                  </p>
                  <p className="text-sm text-gray-600">
